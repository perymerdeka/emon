...
from routers import auth, categories, reports, transactions, budgets, recurring_transactions
...
def create_app() -> FastAPI:
    ...
    app.include_router(recurring_transactions.router, prefix="/recurring-transactions", tags=["Recurring Transactions"]) # Add recurring tx router
